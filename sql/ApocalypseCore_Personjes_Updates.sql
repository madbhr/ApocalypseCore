/* 
* updates\characters\2013_03_04_00_characters_character_queststatus_rewarded.sql 
*/ 
ALTER TABLE `character_queststatus_rewarded` ADD `active` tinyint(3) unsigned NOT NULL DEFAULT '1' AFTER `quest`;
 
 
/* 
* updates\characters\2013_04_05_00_characters_banned_addons.sql 
*/ 
...
/* 
* updates\characters\2013_06_23_00_characters_game_event.sql 
*/ 
