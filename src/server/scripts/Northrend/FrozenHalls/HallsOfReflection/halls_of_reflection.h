...
enum GameObjects
{
    ...
    GO_ICE_WALL_1                                 = 300247,//@CENTRY+0 
    GO_ICE_WALL_2                                 = 300248,//@CENTRY+1 
    GO_ICE_WALL_3                                 = 300249,//@CENTRY+2 
    GO_ICE_WALL_4                                 = 300250,//@CENTRY+3 
    GO_CAVE                                       = 201596,
    GO_STAIRS_SKYBREAKER                          = 201709,
    GO_SKYBREAKER                                 = 300252,//@CENTRY+5
    GO_STAIRS_ORGRIM_HAMMER                       = 202211,
    GO_ORGRIM_HAMMER                              = 300251,//@CENTRY+4
    GO_PORTAL                                     = 202079,
