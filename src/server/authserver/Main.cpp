...
extern int main(int argc, char **argv)
{
    ...
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " A World of Warcraft: Woltk Core Emulator	");
    ...
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " https://github.com/ApocalypseCore/          ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " One Community developers Costa Rica(c) 2013");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " Desarrollado por ApocalypseEmu ");
    sLog->outInfo(LOG_FILTER_AUTHSERVER, " One ");
